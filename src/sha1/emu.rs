...
pub fn sha1nexte(hash: u32x4, msg: u32x4) -> u32x4 {
    add_1st(rotate::left_u32(get_1st(hash), 30), msg)
}
...
pub fn digest_block_arm_emu(
    ...
    let e20 = rotate::left_u32(get_1st(h19), 30);
...
pub fn digest_block_simple(
    m0: u32x4, m4: u32x4, m8: u32x4, m12: u32x4,
    h0: u32x4, e: u32) -> (u32x4, u32) {

    let w0 = m0;
    let h1 = rounds40(h0, u32x4(0, 0, 0, 0), add_1st(e, w0));
    let w1 = m4;
...
pub fn digest_block(m0: u32x4, m4: u32x4, m8: u32x4, m12: u32x4,
                    h0: u32x4, e: u32) -> (u32x4, u32) {
    digest_block_simple(m0, m4, m8, m12, h0, e)
}
...
pub fn init_work(w: &mut [u32]) {
    assert_eq!(w.len(), 80);
    for t in 16us..80us {
        w[t] = rotate::left_u32(w[t-3]^w[t-8]^w[t-14]^w[t-16], 1);
    }
}
